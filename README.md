Example of laravel project I've created during an online quiz using Laravel and VueJS

1. Create a Laravel project
2. Set DB_CONNECTION to sqlite
3. Create a migration for 2 tables (Random [id, values(string), flag], Breakdown [id, values(string),
random_id])
...
iterations from 5-10) that will generate a random 5-character ( alphanumeric ) string for the breakdown
(table)
